...
import { addCommentForPost, addLikeForPost, addBookmarkForPost, deleteBookmarkForPost, postDelete } from 'frontend/redux/actions/postActions';
...
const PostItem = ({
  ...
  const [alreadyBookmark, setAlreadyBookmark] = React.useState( alreadyBookmarkVal );
  ...
  return (
    <>
      ...
      >
        ...
        <Box sx={{ p: 2 }}>
          <Typography component="span" variant="body2" sx={{ color: toggle ? 'text.primary' : '#161C24' }}>
            {description}
          </Typography>
        </Box>
