  ...
  return (
    <>
      ...
      <link rel="canonical" href="https://dint.com"/>
        <title>{'Dint Club: The All-in-One American App for Instant Messaging, Social Media, and Mobile Payments'}</title>
        <meta name="description" content="Discover the power of Dint Club, the cutting-edge American app that seamlessly combines instant messaging, social media, and mobile payments. Stay connected with friends, share moments, and conveniently handle your financial transactions all in one place. Experience the future of digital communication and financial convenience with Dint Club today." />
      </Helmet>
      {/* <NavbarHome /> */}
        ...
        <div className="left-container">
          ...
          <div className="bg-left-content d-flex justify-content-center">
            <div className="left-text">
              <p >Dint Club: The All-in-One American App for Instant Messaging, Social Media, and Mobile Payments
          </p>
              </div>
          </div>
        </div>
